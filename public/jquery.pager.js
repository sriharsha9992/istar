(function($) {
  ...
  var methods = {
    init: function(thead, tr_arg) { 
      ...
      this.html('<table class="table"><thead><tr><th>' + thead.join('</th><th>') + '</th></tr></thead><tbody>' + tbody + '</tbody></table><div class="pagination pagination-centered"><ul><li id="frstpage"><a>&laquo;&laquo;</a></li><li id="prevpage"><a>&laquo;</a></li><li><input id="whatpage" type="text"></li><li id="nextpage"><a>&raquo;</a></li><li id="lastpage"><a>&raquo;&raquo;</a></li></ul></div>');
